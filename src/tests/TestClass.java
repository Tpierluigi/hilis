...
public class TestClass {
  public static void main(String[] args) throws IOException {
    ...
    try {
      ...
      // https://docs.oracle.com/javase/tutorial/essential/exceptions/tryResourceClose.html)
      Table table = connection.getTable(TableName.valueOf("trend"));
      try {
        ...
        p.add(Bytes.toBytes("ingressi"), Bytes.toBytes("someQualifier"),
        ...
        byte [] value = r.getValue(Bytes.toBytes("ingressi"),
        ...
        Scan s = new Scan();
        s.addColumn(Bytes.toBytes("ingressi"), Bytes.toBytes("someQualifier"));
